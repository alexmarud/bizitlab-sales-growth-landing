      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-3xl mx-auto mt-12 space-y-8">
          ...
          <Card className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 reveal">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center p-4">
                <Avatar className="h-16 w-16 mb-4 bg-bizitgreen text-white">
                  <AvatarFallback>НЕ</AvatarFallback>
                </Avatar>
                <h3 className="font-semibold text-xl mb-2">ООО "НЕСЛ"</h3>
                <p className="text-gray-700 italic mb-4">
                  "Выражаем благодарность команде biz.it.lab за профессиональный подход к автоматизации нашего бизнеса. 
                  Внедренная система на базе Битрикс24 позволила нам эффективно организовать учет и контроль выполнения задач. 
                  Особенно ценим настроенные специалистами компании бизнес-процессы и отчеты, которые дают возможность 
                  анализировать эффективность работы сотрудников и принимать взвешенные управленческие решения."
                </p>
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#0075FF" stroke="#0075FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#0075FF" stroke="#0075FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
